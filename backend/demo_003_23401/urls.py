"""demo_003_23401 URL Configuration
...
admin.site.site_header = "demo-003"
admin.site.site_title = "demo-003 Admin Portal"
admin.site.index_title = "demo-003 Admin"

# swagger
api_info = openapi.Info(
    title="demo-003 API",
    default_version="v1",
    description="API documentation for demo-003 App",
)
